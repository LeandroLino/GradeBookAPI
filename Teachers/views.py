    ...
    class TeacherLogin(APIView):
        ...
        def post(self, request):
            ...
            if teacher is not None and check_password(password, teacher.password):
                ...
                token = jwt.encode({'email': teacher.__dict__['email'], 'id': teacher.__dict__['id']}, settings.SIMPLE_JWT['SIGNING_KEY'], algorithm='HS256').decode('utf-8')
...
class TeacherAPI(APIView):
    ...
    def get(self, request, teacher_id=None):
        if teacher_id:
            ...
            disciplines_serializer = DisciplineSerializer(discipline)
